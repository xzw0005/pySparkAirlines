...
APP_NAME = "Group2_1_Top10CarriersOntimeDepartureFromAirportX"
...
res2_1 = lines.map(lambda line : line.split(","))				\
			  .filter(lambda line : line[6] == originAirport)		\ 	# 'SRQ', 'CMH', 'JFK', 'SEA', or 'BOS'
			  .map(lambda line : (line[4], float(line[12])))	\	# (Carrier, Departure Delay)
